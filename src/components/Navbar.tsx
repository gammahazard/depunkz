    ...
    <Box display="flex" alignItems="center" justifyContent="space-between" p={2}>
      ...
      <Box display={{ xs: 'none', md: 'flex' }} alignItems="center" justifyContent="center" flexGrow={1}>
        <Box display="flex" alignItems="center" gap={2}>
          <Link href="/gamelibrary" passHref><Button className="nav-item">Litepaper</Button></Link>
      ...
      <Box display={{ xs: 'none', md: 'flex' }} alignItems="center">
        ...
        <IconButton href="https://discord.com" target="_blank" rel="noopener noreferrer" size="large">
